...
def is_bias(params: FrozenDict) -> FrozenDict:
    """ pytree mask for bias parameters """
    flat_params = flax.traverse_util.flatten_dict(params)
    flat_param_mask = {k: k[-1].endswith('bias') for k in flat_params.keys()}
...
if __name__ == "__main__":
    ...
    optimizer = optax.chain(
        ...
        optax.add_decayed_weights(config.weight_decay, mask=is_bias(params)),
